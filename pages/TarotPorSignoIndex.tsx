                ...
                <div className="flex w-full max-w-[1200px]">
                    <div className="flex items-center justify-between whitespace-nowrap w-full px-3 py-2.5 sm:px-4 sm:py-3 lg:px-10 lg:py-4 gap-2">
                        ...
                        <nav className="hidden lg:flex items-center gap-4 xl:gap-6">
                            <button onClick={() => navigate('/')} className={`text-xs xl:text-sm font-medium transition-colors whitespace-nowrap ${isActive('/') && location.pathname === '/' ? 'text-white' : 'text-gray-400 hover:text-white'}`}>
                                {t.nav.home}
                            </button>
