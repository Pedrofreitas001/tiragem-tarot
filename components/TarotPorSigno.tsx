...
export const TarotPorSigno = () => {
    ...
    // Rotação automática dos módulos
    useEffect(() => {
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <div className={`relative pl-6 border-l-2 ${currentModule.borderColor}`}>
                                                            ...
                                                            <p className={`${currentModule.contentColor} text-lg leading-relaxed`}>
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    {getDynamicModules().map((_, index) => (
                                                        <button
                                                            ...
                                                            className={`relative transition-all duration-300 ${index === currentModuleIndex ? 'w-6 h-2' : 'w-2 h-2 hover:w-3'}`}
                                                        >
                                                            <div className={`absolute inset-0 rounded-full transition-all duration-300 ${index === currentModuleIndex ? 'bg-yellow-400 shadow-md' : 'bg-white/20 hover:bg-white/40'}`} />
                                                        </button>
                                                    ))}
                                                </div>
