            ...
            {selectedMarker && isDetailOpen && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-[#1a1628] to-[#0d0a14] border border-[#875faf]/40 rounded-2xl shadow-2xl">
                                ...
                                <div className="flex gap-5 items-start">
                                    ...
                                    <div className="flex-1 pt-1">
                                        ...
                                        <div className="text-white/80 text-sm">
                                            <div className="font-medium">{isPortuguese ? 'Quantidade' : 'Count'}: <span className="font-bold">{hasAccessToCount ? cardCount : '-'}</span></div>
                            ...
                            <div className="p-6 pt-4">
                                ...
                                <div className="p-4 bg-[#875faf]/10 border border-[#875faf]/20 rounded-lg">
                                    <h4 className="text-[#a77fd4] text-xs uppercase tracking-wider mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>Lição</h4>
